      ...
      <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-[var(--navy)]/80 p-4 shadow-2xl backdrop-blur-xl transition-transform duration-500 group-hover:-translate-y-0.5 sm:p-5">
        ...
        <div className="relative">
          ...
          <div className="relative mt-1.5">
            ...
            />
            <div
              className={`relative font-display font-extrabold leading-none tracking-tight text-white text-[40px] md:text-[44px] lg:text-[56px] xl:text-[64px] transition-opacity duration-1000 ${active ? "opacity-100" : "opacity-0"}`}
            >
