...
import graceFlowerEye from "@/assets/grace-flower-eye.jpg";
import graceReel02Thumb from "@/assets/grace-reel-02-thumb.jpg";
...
export const brandGroups: BrandGroup[] = [
  ...
  },
  {
    ...
    name: "Decolux",
    description:
      "Decolux is a premium interior and décor brand. Dravonix handled their social media creative production, delivering high-quality visual content that reflects the brand's premium aesthetic.",
    services: ["Social Media Marketing", "Graphic Design", "Creative Production"],
    items: [
      {
