...
const routes: Array<{ loc: string; changefreq: string; priority: string }> = [
  ...
  { loc: `${SITE}/draiva/web-chat`, changefreq: "monthly", priority: "0.7" },
  { loc: `${SITE}/draiva/mail`, changefreq: "monthly", priority: "0.7" },
  { loc: `${SITE}/draiva/social`, changefreq: "monthly", priority: "0.7" },
  { loc: `${SITE}/draiva/voice`, changefreq: "monthly", priority: "0.7" },
  ...
  { loc: `${SITE}/data-deletion`, changefreq: "yearly", priority: "0.5" },
];
